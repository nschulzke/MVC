...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#dynamic-modal" data-url="<?= GlobalConfig::getAppPath() ?>/scripture/lookup" data-title="Scripture" data-get-vars='["book","chapter","verses"]'>Load Verses</button>